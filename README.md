...
Read it:
    ...
    Layer, можете исправить сами, буду только рада.
    С WPF первый раз, не умею в них, так что особо на мой код не смотрите. Можете смело всё удалять, только про примерное расположение
